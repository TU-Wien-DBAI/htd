#ifndef HTD_FITNESSMINIMIZINGTREEDECOMPOSITIONALGORITHM_HPP
#define HTD_FITNESSMINIMIZINGTREEDECOMPOSITIONALGORITHM_HPP
...
{
    /**
     *  Default implementation of the ITreeDecompositionAlgorithm interface which calls different algorithms to minimize a fitness function.
     */
    class FitnessMinimizingTreeDecompositionAlgorithm : public htd::ITreeDecompositionAlgorithm
    {
        public:
            /**
             ...
             *
             *  @param[in] original     The original htd::FitnessMinimizingTreeDecompositionAlgorithm object.
             */
            HTD_API FitnessMinimizingTreeDecompositionAlgorithm(const htd::FitnessMinimizingTreeDecompositionAlgorithm & original);

            HTD_API virtual ~FitnessMinimizingTreeDecompositionAlgorithm();
             ...
             *  @return A new ITreeDecomposition object representing the decomposition of the given graph or a null-pointer in case that the decomposition does not have a appropriate maximum bag size or the decomposition is not a valid decomposition of the graph.
             */
            HTD_API htd::ITreeDecomposition * computeDecomposition(const htd::IMultiHypergraph & graph, std::size_t maxBagSize, std::size_t maxIterationCount) const;
             ...
             *  @return A new ITreeDecomposition object representing the decomposition of the given graph or a null-pointer in case that the decomposition does not have a appropriate maximum bag size or the decomposition is not a valid decomposition of the graph.
             */
            HTD_API htd::ITreeDecomposition * computeDecomposition(const htd::IMultiHypergraph & graph, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations, std::size_t maxBagSize, std::size_t maxIterationCount) const;
             ...
             *  @return A new ITreeDecomposition object representing the decomposition of the given graph or a null-pointer in case that the decomposition does not have a appropriate maximum bag size or the decomposition is not a valid decomposition of the graph.
             */
            HTD_API htd::ITreeDecomposition * computeDecomposition(const htd::IMultiHypergraph & graph, const htd::IPreprocessedGraph & preprocessedGraph, std::size_t maxBagSize, std::size_t maxIterationCount) const;
             ...
             *  @return A new ITreeDecomposition object representing the decomposition of the given graph or a null-pointer in case that the decomposition does not have a appropriate maximum bag size or the decomposition is not a valid decomposition of the graph.
             */
            HTD_API htd::ITreeDecomposition * computeDecomposition(const htd::IMultiHypergraph & graph, const htd::IPreprocessedGraph & preprocessedGraph, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations, std::size_t maxBagSize, std::size_t maxIterationCount) const;
        ...
        protected:
             ...
             */
            FitnessMinimizingTreeDecompositionAlgorithm & operator=(const FitnessMinimizingTreeDecompositionAlgorithm &)
            { return *this; }
...
#endif //HTD_FITNESSMINIMIZINGTREEDECOMPOSITIONALGORITHM_HPP
