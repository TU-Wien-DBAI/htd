...
namespace htd
{
    ...
    class ExternalTreeDecompositionAlgorithm : public htd::ITreeDecompositionAlgorithm
    {
        public:
             ...
             */
            HTD_API ExternalTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::string & cmd);
             ...
             *  @param[in] decompostion             String containing the decomposition or the path to the file containing the decomposition.
             */
            HTD_API ExternalTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations, const std::string & cmd);
