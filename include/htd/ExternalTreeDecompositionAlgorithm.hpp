#ifndef HTD_TRELLISTREEDECOMPOSITIONALGORITHM_HPP
#define HTD_TRELLISTREEDECOMPOSITIONALGORITHM_HPP
...
namespace htd
{
    ...
    class ExternalTreeDecompositionAlgorithm : public htd::ITreeDecompositionAlgorithm
    {
        public:
             ...
             */
            HTD_API ExternalTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, char ** cmd, __useconds_t timeout);
             ...
             *  @param[in] decompostion             String containing the decomposition or the path to the file containing the decomposition.
             */
            HTD_API ExternalTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations, char ** cmd, __useconds_t timeout);
...
#endif //HTD_TRELLISTREEDECOMPOSITIONALGORITHM_HPP
