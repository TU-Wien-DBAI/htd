...
namespace htd
{
    ...
    class FileTreeDecompositionAlgorithm : public htd::ITreeDecompositionAlgorithm
    {
        public:
             ...
             */
            HTD_API FileTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::string & decomposition);
             ...
             *  @param[in] decompostion             String containing the decomposition or path to the file containing the decomposition.
             */
            HTD_API FileTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations, const std::string & decomposition);
