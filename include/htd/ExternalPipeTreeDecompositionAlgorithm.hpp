    ...
    class ExternalPipeTreeDecompositionAlgorithm : public htd::IExternalTreeDecompositionAlgorithm
    {
        public:
             ...
             *  @param[in] timeout          The timeout for the external solver in milliseconds.
              ...
              */
            HTD_API ExternalPipeTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, std::string cmd, unsigned int timeout = 0, std::string inputString = "");
             ...
             *  @param[in] timeout                  The timeout for the external solver in milliseconds.
              * @param[in] inputString              A custom string to send the external solver instead of the graph.
              */
            HTD_API ExternalPipeTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations, std::string cmd, unsigned int timeout = 0, std::string inputString = "");
