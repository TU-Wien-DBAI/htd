...
namespace htd
{
    ...
    class FileGraphDecompositionAlgorithm : public htd::IGraphDecompositionAlgorithm
    {
        public:
             ...
             */
            HTD_API FileGraphDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::string & decompPath, const bool & isPath);
             ...
             */
            HTD_API FileGraphDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations, const std::string & decompPath, const bool & isPath);
