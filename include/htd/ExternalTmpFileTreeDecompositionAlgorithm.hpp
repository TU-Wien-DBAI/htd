...
namespace htd
{
    ...
    class ExternalTmpFileTreeDecompositionAlgorithm : public htd::ITreeDecompositionAlgorithm
    {
        public:
             ...
             *  @param[in] decompostion             String containing the decomposition or the path to the file containing the decomposition.
             */
            HTD_API ExternalTmpFileTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations, std::string cmd, __useconds_t timeout, std::string graphFile, std::string decompFile);
