...
{
    /**
     *  Default implementation of the IExternalTreeDecompositionAlgorithm interface which calls an external decomposer and communicates via temporary files.
     */
    class ExternalTmpFileTreeDecompositionAlgorithm : public htd::IExternalTreeDecompositionAlgorithm
    {
        public:
            /**
             ...
             *  @param[in] timeout          The timeout for the external solver in milliseconds.
              * @param[in] inputString      A custom string to send the external solver instead of the graph.
              */
            HTD_API ExternalTmpFileTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, std::string cmd, std::string graphFile, std::string decompFile, unsigned int timeout = 0, std::string inputString = "");
             ...
             *  @param[in] timeout                  The timeout for the external solver in milliseconds.
              * @param[in] inputString              A custom string to send the external solver instead of the graph.
              */
            HTD_API ExternalTmpFileTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations, std::string cmd, std::string graphFile, std::string decompFile, unsigned int timeout = 0, std::string inputString = "");

            /**
             *  Copy constructor for a htd::ExternalTmpFileTreeDecompositionAlgorithm object.
             *
             *  @param[in] original The original htd::ExternalTmpFileTreeDecompositionAlgorithm object.
             */
            ...
            HTD_API void setGraphFilePath(const std::string & path);

            HTD_API std::string getGraphFilePath();

            HTD_API void setDecompositionFilePath(const std::string & path);
